...
following condition:  
     ...
     Line Number ='01400'
     Column Number ='00200'    
 *Note: Refer to the file named 2552-10_Worksheet_Codes.doc to determine worksheet 
...
We did not change the line number to the cost center code like we did for the 2552-96 data files.  
...
6.1 HOSP2010 Data File(s) : HOSP2010_DATA.ZIP 
...
6.5 HOSP2010 rollups: 

	These datasets are deprecated. The methods of combining reported data used in the 2552-96 forms have proven to be unreliable.
	Users are encouraged to develop their own methods of summarizing HCRIS data.
...
Then scroll down to Chapter 40.  
...
(c) 2002 Centers for Medicare & Medicaid Services, All rights reserved.  
www.cms.hhs.gov
